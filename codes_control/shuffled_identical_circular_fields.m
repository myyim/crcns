function gs = shuffled_identical_circular_fields(g2d,thre,seed)
% gs = shuffled_identical__circular_fields(g2d,thre,seed) shuffles grid bumps in g2d assuming that
